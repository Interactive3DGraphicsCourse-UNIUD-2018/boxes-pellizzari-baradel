		...
		function aggiungiMasso(x,z){
			...
			var texture = new THREE.TextureLoader().load('../textures/masso.jpg');
		...
		function aggiungiTronco(x,z){
			...
			var texture = new THREE.TextureLoader().load('../textures/tronco.jpg'); 
		...
		function aggiungiAsteroide(x,z){
			...
			var texture = new THREE.TextureLoader().load('../textures/asteroide.jpg'); 
