		...
		function aggiungiMasso(x,z){
			...
			var texture = THREE.ImageUtils.loadTexture('../textures/masso.jpg'); // new THREE.TextureLoader().load('../textures/masso.jpg');
		...
		function aggiungiTronco(x,z){
			...
			var texture = THREE.ImageUtils.loadTexture('../textures/tronco.jpg'); // new THREE.TextureLoader().load('../textures/tronco.jpg');
		...
		function aggiungiAsteroide(x,z){
			...
			var texture = THREE.ImageUtils.loadTexture('../textures/asteroide.jpg'); // new THREE.TextureLoader().load('../textures/asteroide.jpg');
